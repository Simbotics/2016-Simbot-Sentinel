...
public class DriveToMiddleIntakeBallFrom2CDF implements AutonMode{
	@Override
	public void addToMode(AutonBuilder ab) {
		...
		ab.addCommand(new DriveTurnToGyroAngle(0, 1, 2000));
		...
		ab.addCommand(new DriveStraight(83,3000)); // uses PID
		ab.addCommand(new DriveWait());
		
		ab.addCommand(new DriveStraight(-2,500)); // uses PID
		ab.addCommand(new DriveWait());
	    ...
	    ab.addCommand(new DriveStraight(60,2000)); // uses PID
	    ab.addCommand(new AutonOverride(RobotComponent.ARM));
	    ab.addCommand(new ArmMoveTo(1));
	    ab.addCommand(new DriveWait());
