...
public class DriveToMiddleRoughTerrian implements AutonMode {
	...
	public void addToMode(AutonBuilder ab) {
		...
		ab.addCommand(new DriveTurnToGyroAngle(90, 2, 1500));
		ab.addCommand(new DriveShift(false));
		
		ab.addCommand(new DriveStraightAtOutputForDistance(-1.0,2000));
