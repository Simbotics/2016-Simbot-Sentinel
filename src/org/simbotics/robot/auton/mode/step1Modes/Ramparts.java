...
import org.simbotics.robot.auton.drive.DriveStraightOutputHeadingLock;
...
public class Ramparts implements AutonMode {
	...
	public void addToMode(AutonBuilder ab) {
	      ...
	      ab.addCommand(new DriveStraightAtOutputForDistance(1.0,3500,180));
