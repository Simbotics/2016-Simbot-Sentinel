...
public class DriveUpToGoalFrom2ForHighGoal implements AutonMode {
	...
	public void addToMode(AutonBuilder ab) {
		...
		ab.addCommand(new DriveShift(false)); // high Gear
		
		//ab.addCommand(new DriveShift(true));
		ab.addCommand(new DriveStraight(85, 1.0, 3000));
		ab.addCommand(new DriveWait());
		
		ab.addCommand(new DriveShift(false));
		ab.addCommand(new DriveTurnToGyroAngle(45, 1.5, 1500));
		ab.addCommand(new DriveWait());
		
		ab.addCommand(new DriveStraight(-27, 1.5, 1500));
		ab.addCommand(new DriveWait());
