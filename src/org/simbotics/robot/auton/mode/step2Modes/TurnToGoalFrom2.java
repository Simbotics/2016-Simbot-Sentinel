...
public class TurnToGoalFrom2 implements AutonMode {
	@Override
	public void addToMode(AutonBuilder ab) {
		...
		ab.addCommand(new DriveTurnToGyroAngle(25, 5, 2000));
		ab.addCommand(new DriveWait());
		
		ab.addCommand(new DriveStraight(55, 4.5, 1500));
		ab.addCommand(new DriveWait());
		
		ab.addCommand(new DriveTurnToGyroAngle(65, 2.5, 2000));
		ab.addCommand(new DriveWait());
